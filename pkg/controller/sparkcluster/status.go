...
func (r *ReconcileSparkCluster) updateStatus(instance *sparkv1alpha1.SparkCluster) error {
	...
	err = r.client.Get(context.TODO(), types.NamespacedName{Name: uiServiceName(instance), Namespace: instance.Namespace}, uiService)
	if err != nil {
...
func (r *ReconcileSparkCluster) syncStatus(instance *sparkv1alpha1.SparkCluster) error {
	old := &sparkv1alpha1.SparkCluster{}
	...
	// log.Info("update ", "!!instance  name:",instance.Name,"instance namespace:",instance.Namespace,"old name:",old.Name,"old Namespace:",old.Namespace)

	if !reflect.DeepEqual(old.Status, instance.Status) {
		// log.Info("Status Not equal", "not equal status:%v",instance.Status)
		err = r.client.Update(context.TODO(), instance)
		if err != nil {
			log.Info("update error", "!!update error name:", instance.Name, "namespace:", instance.Namespace)
			log.Error(err, "update error:", "update error name:", instance.Name)
		}
		log.Info("Status Not equal", "not equal status: ", instance.Status)
		return err
	}
...
func (r *ReconcileSparkCluster) updateEndpoints(instance *sparkv1alpha1.SparkCluster, pods []corev1.Pod, uiService corev1.Service) error {
...
func ServicesForLabels(instance *sparkv1alpha1.SparkCluster, c client.Client) ([]corev1.Service, error) {
	...
	uiService := &corev1.Service{}
	err = c.Get(context.TODO(), types.NamespacedName{Name: uiServiceName(instance), Namespace: instance.Namespace}, uiService)
	if err != nil {
		return nil, err
	}
